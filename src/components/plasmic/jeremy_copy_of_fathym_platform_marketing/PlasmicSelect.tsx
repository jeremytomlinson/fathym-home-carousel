...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: F9z9zX4HDzvKtC/component
import Select__Option from "../../Select__Option"; // plasmic-import: 8KDU-ex2yfCCbX/component
...
import * as sty from "./PlasmicSelect.module.css"; // plasmic-import: 5_BXBUlYliyqAG/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: VSfgAGAemxEGsn/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: -LWIU7BHcgh1xd/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__xeyhh)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__y104R)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
