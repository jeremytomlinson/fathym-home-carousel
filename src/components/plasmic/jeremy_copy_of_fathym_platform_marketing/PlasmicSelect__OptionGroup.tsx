...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: UX7zbYeJlQQ8FL/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__hutvg)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__wSqx0)}
              />
            </React.Fragment>
          ),
          value: args.children
