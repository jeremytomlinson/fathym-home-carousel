...
import * as sty from "./PlasmicCheckbox.module.css"; // plasmic-import: B4sRjoqVB4esQy/css

import SquaresvgIcon from "./icons/PlasmicIcon__Squaresvg"; // plasmic-import: MMbnCw4gY5VA9Y/icon
import SquareCheckFilledsvgIcon from "./icons/PlasmicIcon__SquareCheckFilledsvg"; // plasmic-import: 8hT3TiLKdvTguv/icon
import SquareMinussvgIcon from "./icons/PlasmicIcon__SquareMinussvg"; // plasmic-import: -2Hdy2ARNfGou-/icon
