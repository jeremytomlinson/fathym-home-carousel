...
import * as sty from "./PlasmicFooterBlack.module.css"; // plasmic-import: rHgO-39egQxvYe/css

import HabistackLogosvgIcon from "./icons/PlasmicIcon__HabistackLogosvg"; // plasmic-import: XuJPg2_ASp4AcN/icon
import blog01390X290Jpg2JTiCyWzShxcjha from "./images/blog01390X290Jpg2.jpeg"; // plasmic-import: JTiCYWzShxcjha/picture
import blog4390X290Jpg29Qn4WWx75Ugw from "./images/blog4390X290Jpg2.jpeg"; // plasmic-import: 9QN4-WWx75-ugw/picture
import blog2390X290Jpg2Zck5XUnpQc4LzV from "./images/blog2390X290Jpg2.jpeg"; // plasmic-import: ZCK5xUNPQc4LzV/picture
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.columns__bjL2)}>
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column__kLzc)}
            >
            ...
            <div className={classNames(projectcss.all, sty.column__mjGw1)}>
              <h5
                className={classNames(
                  projectcss.all,
                  projectcss.h5,
            ...
            <div className={classNames(projectcss.all, sty.column___9Dg2)}>
              <h5
                className={classNames(
                  projectcss.all,
                  projectcss.h5,
              ...
              <div className={classNames(projectcss.all, sty.columns__k12Cn)}>
                <div className={classNames(projectcss.all, sty.column__vAt8C)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__yDjK)}
                    ...
                    src={{
                      src: blog01390X290Jpg2JTiCyWzShxcjha,
                      fullWidth: 390,
                      fullHeight: 290,
                ...
                <div className={classNames(projectcss.all, sty.column__oJubE)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__yQnbF)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                    ...
                    loading={"lazy" as const}
                    src={{
                      src: blog4390X290Jpg29Qn4WWx75Ugw,
                      fullWidth: 390,
                      fullHeight: 290,
                      aspectRatio: undefined
                    }}
                ...
                <div className={classNames(projectcss.all, sty.column__u7TqP)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__tNExq)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                    ...
                    loading={"lazy" as const}
                    src={{
                      src: blog2390X290Jpg2Zck5XUnpQc4LzV,
                      fullWidth: 390,
                      fullHeight: 290,
                      aspectRatio: undefined
                    }}
              ...
              <div className={classNames(projectcss.all, sty.columns__nCw5E)}>
                <div className={classNames(projectcss.all, sty.column__uNQ2)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__o08Qv)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__md7PP)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img___5ZHkx)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__mZlg)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__i0Ciq)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
