...
import * as sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: UY0O2sO6tg1fm9/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__kBHkP)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__jdhcL)}>
            <Button
