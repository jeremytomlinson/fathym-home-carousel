...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: J75NJCF8iocPfm/css

import smalljpgTsigld8Tr4HN8X from "./images/smalljpg.jpeg"; // plasmic-import: Tsigld8TR4hN8x/picture
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__izSbd)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__aHm1W)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__mfFS)}>
            <h5
